		...
		<>
			...
			<Container className="mt-5 pt-5">
				<>
					...
					<ul>
						...
						<li>
							<p>
								...
								Agreement) refers to The Brilliant Ideas, Milan
								chowk, Biratnagar.
							</p>
						</li>
						<li>
						...
						<li>
							<p>
								<strong>Website</strong> refers to The Brilliant
								Ideas, accessible from{" "}
								<a
									href="https://www.thebrilliantideas.com/"
					...
					<ul>
						<li>
							<p>By email: info@thebrilliantideas.com</p>
						</li>
						<li>
							<p>
								By visiting this page on our website:{" "}
								<a
									href="https://www.thebrilliantideas.com/contact"
									rel="external nofollow noopener"
									target="_blank"
								>
									https://www.thebrilliantideas.com/contact
								</a>
							</p>
						</li>
					</ul>
