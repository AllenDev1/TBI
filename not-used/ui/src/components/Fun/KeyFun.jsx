...
const KeyFun = () => {
	...
	function targetRandomKey() {
		const keyt = document.getElementById(getRandomKey());

		try {
			keyt.classList.add("selected");
		} catch (err) {
			console.error(err);
		}
	...
	return (
		<>
			<div className="background-key-change">
				<Container>
					<h1 className="title-key">Eyes on the screen</h1>
					<div className="keyboard">
						<ul className="row row-0 lala">
						...
						<ul className="row row-1 lala">
							...
							<li className="pointer2nd key-tbi" id="T">
								T
							</li>
							...
							<li className="middle key-tbi" id="I">
								I
							</li>
						...
						<ul className="row row-3 lala">
							...
							<li className="pointer2nd key-tbi" id="B">
								B
							</li>
					...
					<h1 className="title-key-buttom">Hands on the keyboard</h1>
				</Container>
			</div>
		</>
	);
