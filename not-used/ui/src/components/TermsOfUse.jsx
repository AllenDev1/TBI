	...
	return (
		<>
			...
			<Container className="mt-5 pt-5">
				<h2>The Brilliant Ideas (TBI) Terms of Use</h2>

				<p>Version 1.0</p>

				<p>
					The The Brilliant ideas website located at
					https://www.thebrilliantideas.com is a copyrighted work
					belonging to The Brilliant Ideas. Certain features of the
				...
				<p>
					...
					sent to: Biratnagar, Nepal. After the Notice is received,
				...
				<p>Email: info@thebrilliantideas.com</p>
			</Container>
		</>
	);
};
